...
Cette mise à jour ajoute le support **OAuth2 autonome** pour l'intégration Samsung TV Smart.  
...
Copie ces fichiers dans `custom_components/samsungtv_smart/` :
- `manifest.json`
- `const.py`
- `config_flow.py`
- `oauth_helper.py`
...
4. Sélectionne "Samsung TV Smart"
