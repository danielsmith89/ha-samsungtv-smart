# Samsung TV Smart - v6.3.0 (OAuth2 Support)
...
2. **Configurer Home Assistant :**
   ...
   - Sélectionner **SamsungTV Smart**
   - Entrer le Client ID et Client Secret

3. **Ajouter l'intégration :**
   - Ajouter l'intégration Samsung TV Smart
...
2. Ajouter l'intégration Samsung TV Smart
...
1. Ajouter l'intégration Samsung TV Smart
...
2. Aller dans **Paramètres → Appareils & Services → Samsung TV Smart**
